...
3. Exporta la base de datos, el ejemplo se encuentra  [aquí]([https://www.ejemplo.com](https://www.youtube.com/watch?v=z5-F9TomceQ&t=411s)), la base de datos se encuentra [acá](https://github.com/paein27/ProyectoIngesoft/tree/main/proyetoIngesoft).
